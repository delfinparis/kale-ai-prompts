...
export default function HeartlandThankYouPage() {
  return (
    <div
      style={{
        minHeight: "100vh",
      ...
      <div style={{ maxWidth: 600, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 15, color: "#94a3b8", lineHeight: 1.6 }}>
            ...
            The full session replay. Your prompt guide. A free strategy
        ...
        >
          Watch the full session replay above, then grab the prompts below.
        </p>
        ...
        >
          ...
          >
            14-page PDF with every prompt from the session, plus "Why This
            Prompt Works" breakdowns and pro tips.
          </p>
          <div
            style={{
              display: "inline-block",
        ...
        >
          ...
          >
            I&apos;m doing free 15-minute AI strategy sessions this week.
            I&apos;ll audit your tech stack and build you 3 workflows specific
            to your business.
          </p>
          <p
            style={{
          ...
          >
            I&apos;m also researching a new AI segment for the podcast and need
            your feedback - what&apos;s working, what&apos;s not, what you wish
            AI could do.
          </p>
          <div
            style={{
